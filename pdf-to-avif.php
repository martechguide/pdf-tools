...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert PDF to AVIF Online</h1>
  ...
  <div class="toolarea-pdf">
    ...
    <div id="options">
        <button id="convert-btn" class="btn btn-primary">Convert to AVIF</button>
  ...
  <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvcGF2aS5qcyIgZGVmZXI9IiI+PC9zY3JpcHQ+"));</script>
