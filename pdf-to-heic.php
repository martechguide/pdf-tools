...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert PDF to HEIC Online</h1>
 ...
 #pdf-upload {
    ...
    <div id="section-tool">
        ...
        <div id="options">
            <button id="convert-btn" class="btn btn-primary">Convert to HEIC</button>
  ...
  <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvcGhjLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
