...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert XML to PDF Online</h1>
...
<div class="drag-drop" id="drag-drop-area">
    ...
    <input type="file" id="file" name="file" accept=".xml" onchange="handleFileUpload(event)">
</div>

<div id="upload-success-message" style="display: none;">
    <center>
        <img src="https://img.icons8.com/ios-filled/50/000000/xml.png" alt="XML Icon">
    </center>
    <div id="fileNameDisplay"></div>
</div>

<label for="content">Or enter xml code here:</label><br>
