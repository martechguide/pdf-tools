...
<?php include('admin/header.php'); ?>
  ...
  <div class="toolarea-pdf">
    ...
    <div class="drag-drop" id="drag-drop-area">
        ...
        <input type="file" id="file" accept=".pdf" onchange="loadPDF(event)">
    </div>
    <div id="upload-message">
        <p>File Uploaded Successfully.</p>
    </div>
    <button onclick="reversePDF()">Reverse PDF</button>
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvcmV2LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
