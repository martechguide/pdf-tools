        function handleFileUpload(file) {
            if (file.type !== "image/x-tga" && !file.name.endsWith(".tga")) {
                alert("Please upload a TGA file.");
                return;
            }

            // Example conversion code for TGA files, replace with actual conversion logic
