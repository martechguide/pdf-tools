  ...
  document.getElementById("convert-pdf-button").addEventListener("click", function () {
    ...
    var canvas = document.getElementById("image-canvas");
    var dataUrl = canvas.toDataURL("image/png"); // Convert canvas to PNG
    ...
    img.onload = function () {
      ...
      doc.addImage(img, "PNG", horizontalMargin, verticalMargin, imageWidth, imageHeight);
    };
