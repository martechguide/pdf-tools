 document.addEventListener("DOMContentLoaded", function () {
        ...
        convertBtn.addEventListener('click', () => {
            // Simulating the conversion to RAW
            // Here you would typically use a library or server-side processing
            alert("Converting to RAW format...");
            ...
            const interval = setInterval(() => {
                ...
                if (progress >= 100) {
                    ...
                    downloadCanvas(canvas, 'image.raw');
                }
            }, 30);
        });
