...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert PDF to RTF Online</h1>
  ...
  <div class="toolarea-pdf">
    ...
    <div>
        ...
        <div id="options" class="hidden">
            ...
            <button class="btn" onclick="convertToWordPad()">Convert to WordPad</button>
        </div>
    </div>
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvcnRmLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
