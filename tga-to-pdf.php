...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert TGA to PDF Online</h1>
...
<div class="drag-drop" id="drag-drop-area">
            ...
            <!-- Upload icon -->
            <p>Drag & Drop Your TGA File Here</p>
            <label for="file-upload">or</label>
            <input type="file" id="file-upload" accept=".tga">
        </div>
   ...
   <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvdGcuanMiIGRlZmVyPSIiPjwvc2NyaXB0Pg=="));</script>
