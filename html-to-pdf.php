...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert HTML to PDF Online</h1>
    <strong>Easily convert, resize, compress, edit, upscale and merge for your PDFs online.</strong>
  </div>
  <div class="toolarea-pdf">
<div>
    <input type="file" id="htmlFileInput" accept=".html" onchange="handleFileUpload()"><br>
    <div id="upload-message" style="display: none;">File uploaded successfully!</div>
    <div id="fileNameDisplay" style="display: none;"></div>
    <br>or<br>
    <label for="pdfHtmlInput">Enter HTML code:</label>
    <textarea id="pdfHtmlInput" rows="10" cols="50"></textarea><br>
    
    <button onclick="generatePDF()">Generate PDF</button>
</div>
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvaHRtLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
