...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert JavaScript to PDF Online</h1>
...
<div class="drag-drop" id="drag-drop-area">
    ...
    <p>Drag & Drop Your JavaScript File Here</p>
    <label for="file">or</label>
    <input type="file" id="file" name="file" accept=".js" onchange="handleFileUpload(event)">
</div>
...
<label for="content">Or enter javascript code here:</label><br>
