...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert YAML to PDF Online</h1>
...
<div class="drag-drop" id="drag-drop-area">
    ...
    <input type="file" id="file" name="file" accept=".yaml" onchange="handleFileUpload(event)">
</div>
...
<label for="content">Or enter yaml code here:</label><br>
