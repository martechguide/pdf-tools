...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert PDF to ICO Online</h1>
...
#pdf-upload {
    ...
    <div id="options">
        <button id="convert-btn" class="btn btn-primary">Convert to ICO</button>
   ...
   <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvcGljby5qcyIgZGVmZXI9IiI+PC9zY3JpcHQ+"));</script>
