...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Speech Text to PDF Online</h1>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.68/pdfmake.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.68/vfs_fonts.js"></script>
        ...
        <div>
            ...
            <button id="download-pdf-btn">Download as PDF</button><br/><br/>
        </div>
    <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvc3B0LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
