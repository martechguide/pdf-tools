...
<div id="options">
    <button id="convert-btn" class="btn btn-primary">Convert to JPG</button>
...
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvcGpwLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
