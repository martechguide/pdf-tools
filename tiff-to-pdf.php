...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert TIFF to PDF Online</h1>
  ...
  <p>Drag & Drop Your TIFF File Here</p>
  <label for="file-upload">or</label>
  <input type="file" id="file-upload" accept="image/tiff">
</div>
...
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvdGlmLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
