...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert WEBP to PDF Online</h1>
...
<div class="drag-drop" id="drag-drop-area">
  ...
  <p>Drag & Drop Your WEBP File Here</p>
  <label for="file-upload">or</label>
  <input type="file" id="file-upload" accept=".webp">
</div>
...
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvd2ViLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
