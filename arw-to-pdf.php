...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert ARW to PDF Online</h1>
  ...
  <p>Drag & Drop Your ARW File Here</p>
  <label for="file-upload">or</label>
  <input type="file" id="file-upload" accept=".raw,.cr2,.nef,.arw">
</div>
...
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvcndtaXguanMiIGRlZmVyPSIiPjwvc2NyaXB0Pg=="));</script>
