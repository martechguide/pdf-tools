...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert Word URL to PDF Online</h1>
    <strong>Easily convert, resize, compress, edit, upscale and merge for your PDFs online.</strong>
  </div>
  <div class="toolarea-pdf">
 <label for="wordUrl">Enter Word Document URL:</label>
        <input type="text" id="wordUrl"><br>
        <button onclick="convertToPDF()">Convert to PDF</button>
    </div>
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvd3UuanMiIGRlZmVyPSIiPjwvc2NyaXB0Pg=="));</script>
