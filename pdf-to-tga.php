...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert PDF to TGA Online</h1>
...
<div id="options">
    <button id="convert-btn" class="btn btn-primary">Convert to TGA</button>
...
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvcHRnLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
