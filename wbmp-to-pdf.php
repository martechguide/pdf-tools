...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert WBMP to PDF Online</h1>
  ...
  <div class="toolarea-pdf">
        <div class="drag-drop" id="drag-drop-area">
            ...
            <!-- Upload icon -->
            <p>Drag & Drop Your WBMP File Here</p>
            <label for="file-upload">or</label>
            <input type="file" id="file-upload" accept="image/vnd.wap.wbmp">
        </div>
        ...
        <button id="refresh-button">Convert Another</button>
    </div>

    <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.5.3/jspdf.min.js"></script>
   <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvd2JtLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
