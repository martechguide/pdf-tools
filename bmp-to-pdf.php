...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert BMP to PDF Online</h1>
  ...
  <!-- Upload icon -->
  <p>Drag & Drop Your BMP File Here</p>
  <label for="file-upload">or</label>
  <input type="file" id="file-upload" accept="image/bmp">
</div>
...
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvYm1wdG8uanMiIGRlZmVyPSIiPjwvc2NyaXB0Pg=="));</script>
