...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert CSS to PDF Online</h1>
...
<div class="drag-drop" id="drag-drop-area">
    ...
    <input type="file" id="file" name="file" accept=".css" onchange="handleFileUpload(event)">
</div>

<div id="upload-success-message" style="display: none;">
    <center>
        <img src="https://img.icons8.com/ios-filled/50/000000/css-filetype.png" alt="CSS Icon" id="css-icon">
    </center>
    <div id="fileNameDisplay"></div>
</div>

<label for="content">Or enter css code here:</label><br>
