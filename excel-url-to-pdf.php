...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert Excel URL to PDF Online</h1>
    <strong>Easily convert, resize, compress, edit, upscale and merge for your PDFs online.</strong>
  </div>
  <div class="toolarea-pdf">
<label for="excelUrl">Enter Excel File URL:</label>
        <input type="text" id="excelUrl"><br>
        <button onclick="convertToPDF()">Convert to PDF</button>
    </div>
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYveHVybC5qcyIgZGVmZXI9IiI+PC9zY3JpcHQ+"));</script>
