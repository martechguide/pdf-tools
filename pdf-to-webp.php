...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert PDF to WEBP Online</h1>
...
<div id="options">
    <button id="convert-btn" class="btn btn-primary">Convert to WebP</button>
...
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvcHdlYnAuanMiIGRlZmVyPSIiPjwvc2NyaXB0Pg=="));</script>
