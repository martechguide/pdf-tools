...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert PHP to PDF Online</h1>
...
<div class="drag-drop" id="drag-drop-area">
    ...
    <p>Drag & Drop Your PHP File Here</p>
    <label for="file">or</label>
    <input type="file" id="file" name="file" accept=".php" onchange="handleFileUpload(event)">
</div>

<div id="upload-success-message" style="display: none;">
    <center>
        <img src="https://img.icons8.com/ios-filled/50/000000/php.png" alt="PHP Icon">
    </center>
    <div id="fileNameDisplay"></div>
</div>

<label for="content">Or enter php code here:</label><br>
