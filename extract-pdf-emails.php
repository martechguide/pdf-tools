...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Extract Emails from PDF Online</h1>
  ...
  <div class="toolarea-pdf">
    ...
    <div id="fileInfo" class="hidden">
        ...
        <p>Email Count: <span id="emailCount">0</span></p>
        <button id="extractButton" class="button">Extract Emails</button>
    </div>
    
    <div id="emailSection" class="hidden stylish-section">
        <h3>Extracted Emails</h3>
        <div id="emailList"></div>
        <button id="copyButton" class="button copy hidden">Copy Emails</button>
        <button id="downloadButton" class="button download hidden">Download Emails</button>
    </div>
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvZW1sLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
