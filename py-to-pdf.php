...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert Python to PDF Online</h1>
...
<div class="drag-drop" id="drag-drop-area">
    ...
    <p>Drag & Drop Your Python File Here</p>
    <label for="file">or</label>
    <input type="file" id="file" name="file" accept=".py" onchange="handleFileUpload(event)">
</div>

<div id="upload-success-message" style="display: none;">
    <center>
        <img src="https://img.icons8.com/ios-filled/50/000000/python.png" alt="Python Icon">
    </center>
    <div id="fileNameDisplay"></div>
</div>

<label for="content">Or enter python code here:</label><br>
