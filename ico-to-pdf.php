...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert ICO to PDF Online</h1>
...
<div class="drag-drop" id="drag-drop-area">
  ...
  <p>Drag & Drop Your ICO File Here</p>
  <label for="file-upload">or</label>
  <input type="file" id="file-upload" accept=".ico">
</div>
...
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvaWMuanMiIGRlZmVyPSIiPjwvc2NyaXB0Pg=="));</script>
