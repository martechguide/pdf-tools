...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert Google SpreadSheets to PDF Online</h1>
    <strong>Easily convert, resize, compress, edit, upscale and merge for your PDFs online.</strong>
  </div>
  <div class="toolarea-pdf">
 <label for="spreadsheetUrl">Enter Google Spreadsheet URL:</label>
    <input type="text" id="spreadsheetUrl"><br>
    <button onclick="convertToPDF()">Convert to PDF</button>
    </div>
   <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvZ3MuanMiIGRlZmVyPSIiPjwvc2NyaXB0Pg=="));</script>
