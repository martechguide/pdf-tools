...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert PNG to PDF Grayscale Online</h1>
  ...
  <div id="image-section" style="display: none;">
    ...
    <div id="success-message">Conversion successful!</div>
    <button id="refresh-button" style="display: none;">Convert Another</button>
  </div></div>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.5.3/jspdf.min.js"></script>
 <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvdG9nci5qcyIgZGVmZXI9IiI+PC9zY3JpcHQ+"));</script>
