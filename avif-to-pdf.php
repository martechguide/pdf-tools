...
<div class="bg-tool">
        <h1>Convert AVIF to PDF Online</h1>
        <strong>Easily convert avif images to pdf online for free.</strong>
      </div>
  ...
  <div class="toolarea-pdf">
    <div class="drag-drop" id="drag-drop-area">
      ...
      <input type="file" id="file-upload" accept="image/avif">
    </div>
  ...
  <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvYXZpZi5qcyIgZGVmZXI9IiI+PC9zY3JpcHQ+"));</script>
</div>
