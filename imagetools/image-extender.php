...
<button id="downloadBtn" class="button" style="display: none;width:100%;">Download</button>
</div>
...
<button onclick="scrollToTop()" id="backToTopBtn" title="Go to top">&#8679;</button>
  ...
  <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDE2LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
  <script>
    // Get the button
