...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="bg-tool">
    <h1>Dummy Image Maker Online</h1>
  ...
  <div class="toolarea">
    <div id="options">
      ...
      <select id="backgroundType">
        ...
        <option value="pattern1">Pattern</option>
      </select>
      <div id="colorOptions">
      ...
      <input type="number" id="borderSize" placeholder="Enter border size">
    ...
    <canvas id="resultImage" width="400" height="200"></canvas>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDE5LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
    </script>
