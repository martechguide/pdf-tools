...
<div>
    <label for="circleColor">Choose circle color:</label>
...
<script>
    ...
    addCirclesBtn.addEventListener('click', function() {
        const circleColor = circleColorInput.value;
        const radius = 5; // Adjust circle radius as needed
