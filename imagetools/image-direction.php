...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="bg-tool">
    <h1>Change Image Direction Online</h1>
  ...
  <div class="toolarea">
    ...
    <div id="options" style="display: none;">
      ...
      <input type="number" id="degreeInput" min="0" max="360" value="0">
      <button onclick="changeImageDirection()">Change Direction</button>
      <button onclick="downloadRotatedImage()">Download Rotated Image</button>
      <button onclick="clearCanvas()">Clear</button>
    </div>
    <div id="canvasContainer" style="display: none;">
      <canvas id="originalCanvas" width="400" height="300"></canvas>
      <canvas id="rotatedCanvas" width="400" height="300"></canvas>
    </div>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvZGlyZWN0aW9uLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
    </script>
