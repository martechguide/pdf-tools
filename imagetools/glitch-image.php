...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="bg-tool">
    <h1>Add Image Glitch Effect Online</h1>
  ...
  <div class="toolarea">
    ...
    <button onclick="downloadImage()">Download Glitched Image</button>
    <button onclick="resetCanvas()">Reset</button>
    <br>
    <br>
    <canvas id="originalCanvas" width="400" height="300" style="border:1px solid black;"></canvas>
    <canvas id="glitchCanvas" width="400" height="300" style="border:1px solid black;"></canvas>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDMzLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
    </script>
