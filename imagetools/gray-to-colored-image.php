...
<div class="bg-tool">
        <h1>Convert Image to Grayscale Online</h1>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/camanjs/4.1.2/caman.full.min.js"></script>
      ...
      <input type="file" id="fileInput" onchange="loadImage()" /><br/>
      <canvas id="originalImage"></canvas>
      <br>
      <button onclick="convertToBlackAndWhite()">Convert</button><br/>
  ...
  <script>
    ...
    function downloadImage() {
      convertedCanvas.toBlob(function(blob) {
        ...
        link.download = "blackAndWhiteImage.jpg";
        link.click();
      });
    }
  </script>
