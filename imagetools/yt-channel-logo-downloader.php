...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="bg-tool">
    <h1>YouTube Channel Logo Downloader</h1>
  ...
  <div class="toolarea">
    ...
    <br>
    <button onclick="downloadChannelLogo()">Generate</button>
    <br>
    <canvas id="logoCanvas" width="200" height="200"></canvas>
    <br>
    <button onclick="downloadAsPNG()">Download</button>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDM1LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
    </script>
