...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="bg-tool">
    <h1>Round Profile Image Online</h1>
  ...
  <div class="toolarea">
    ...
    <br>
    <button id="apply-button">Apply Shape</button>
    <canvas id="output-canvas" width="500" height="500" style="display: none;"></canvas>
    <button id="download-button" style="display: none;">Download Image</button>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvcm91bmQuanMiIGRlZmVyPSIiPjwvc2NyaXB0Pg=="));
    </script>
