...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="bg-tool">
    <h1>Convert Image to Gray Dutone Online</h1>
  ...
  <div class="toolarea">
    <div id="uploadSection">
      <input type="file" id="imageInput" accept="image/*" onchange="displayOptions()">
    </div>
    <div id="optionsSection" style="display: none;">
      ...
      <div class="canvas-container">
        <canvas id="originalCanvas" style="border:1px solid black;"></canvas>
        <canvas id="convertedCanvas" style="border:1px solid black;"></canvas>
      </div>
    </div>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDI1LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
    </script>
    <style>
      .canvas-container {
        display: flex;
