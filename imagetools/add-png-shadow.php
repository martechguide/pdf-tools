...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="bg-tool">
    <h1>Add PNG Image Shadow Online</h1>
  ...
  <div class="toolarea">
    <style>
      ...
      img {
        max-width: 100%;
        max-height: 400px;
        box-shadow: var(--shadow-color) var(--shadow-offset-x) var(--shadow-offset-y) var(--shadow-blur) var(--shadow-inset);
      }
    </style>
    ...
    <div id="shadow-options" style="display: none;">
      ...
      <input type="number" id="shadow-blur" min="0" value="10">
      <label for="shadow-offset-x">Shadow Offset X (px):</label>
      <input type="number" id="shadow-offset-x" value="0">
      <label for="shadow-offset-y">Shadow Offset Y (px):</label>
      <input type="number" id="shadow-offset-y" value="0">
      <br>
      <label for="shadow-inset">Inset Shadow:</label>
      <input type="checkbox" id="shadow-inset">
      <br>
      <button id="apply-shadow">Apply Shadow</button>
      <button id="reset-shadow" style="display:none;">Reset</button>
      <button id="download-image" style="display:none;">Download Image</button>
    </div>
    <img id="image-preview" alt="Image Preview" src="https://via.placeholder.com/400" />
  </div>
  <script>
    document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvc2hkLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
  </script>
