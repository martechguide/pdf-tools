...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="bg-tool">
    <h1>Image Face Swap AI Online</h1>
  ...
  <div class="toolarea">
    <center>
      <p>Please wait while we load playground...</p>
    </center>
    <style>
      .wrap.svelte-b0hvie {
        border: 0;
    ...
    <script>
      document.write(atob("PHNjcmlwdCBzcmM9Imh0dHBzOi8vZ3JhZGlvLnMzLXVzLXdlc3QtMi5hbWF6b25hd3MuY29tLzQuMjkuMC9ncmFkaW8uanMiIHR5cGU9Im1vZHVsZSI+PC9zY3JpcHQ+"));
    </script>
    <div id="psscd">
      <gradio-app src="https://mrbeliever-face-swapper.hf.space"></gradio-app>
    </div>
  </div>
