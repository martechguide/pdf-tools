...
<html lang="en"> <?php include('admin/head.php'); ?> <?php include('admin/header.php'); ?> <?php include('admin/user.php'); ?> <div id="post-header" class="post-header">
  ...
  <div class="bg-tool">
    <h1>Broken Image Effects Online</h1>
  ...
  <div class="toolarea">
    ...
    <br>
    <br>
    <button onclick="applyBrokenMirrorEffect()">Apply Broken Mirror Effect</button>
    <br>
    <br>
    <canvas id="originalCanvas" width="400" height="300" style="border:1px solid black;"></canvas>
    <canvas id="brokenMirrorCanvas" width="400" height="300" style="border:1px solid black;"></canvas>
    <br>
    <br>
  ...
  <script>
    document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9pbWcvMDIxLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));
  </script>
  <script>
    // Get the button
