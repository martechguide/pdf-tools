...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert PDF to RAW Online</h1>
...
<div id="options">
    <button id="convert-btn" class="btn btn-primary">Convert to RAW</button>
...
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvcHJhdy5qcyIgZGVmZXI9IiI+PC9zY3JpcHQ+"));</script>
