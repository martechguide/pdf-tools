...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert Markdown to PDF Online</h1>
...
<div class="drag-drop" id="drag-drop-area">
    ...
    <input type="file" id="file" name="file" accept=".md" onchange="handleFileUpload(event)">
</div>
...
<label for="content">Or enter markdown code here:</label><br>
