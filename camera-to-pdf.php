...
<?php include('admin/header.php'); ?>
  ...
  <div class="bg-tool">
    <h1>Convert Web Camera to PDF Online</h1>
...
<button id="capture-button">Capture and Convert to PDF</button>
<script>document.write(atob("IDxzY3JpcHQgc3JjPSJqcy9wZGYvY2FtLmpzIiBkZWZlcj0iIj48L3NjcmlwdD4="));</script>
